...
import {
    ...
    Eye, FilterX, History, MapPin, MoreHorizontal, Plus, PowerOff, Search, Trash2,
    User, XCircle
} from 'lucide-react';
        ...
        <>
            <div className="p-8 max-w-400 mx-auto space-y-6 animate-in fade-in duration-500 text-foreground">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Button variant="primary" icon={Plus} onClick={() => setOpen(true)}>New Connection</Button>
                    </div>
                </div>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent
                    ...
                    className='p-0 sm:max-w-5xl gap-0'
                >
                    <DialogHeader className='p-6'>
                        <DialogTitle>Create Connection</DialogTitle>
                        <DialogDescription className='hidden'>New Connection</DialogDescription>
                    </DialogHeader>
